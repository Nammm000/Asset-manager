...
- Specs cover components (`src/app/component/**`), the `auto-hide-scrollbar` directive, `route-guard.service`, `auth.interceptor`, `auth.service`, and `jwt-util` — 19 spec files total.
