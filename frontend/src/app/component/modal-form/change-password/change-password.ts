...
export class ChangePassword {
  ...
  // Validation states
  readonly passwordRequirements = computed(() => checkPasswordRequirements(this.newPassword()));
    ...
    this.authService
      ...
      .subscribe({
        ...
        error: (error) => {
          ...
          this.errorMessage.set(getApiErrorMessage(error, 'Password change failed. Please try again.'));
        },
      });
  }
